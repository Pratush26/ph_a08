    ...
    return (
        <header className="bg-white shadow shadow-gray-300 text-sm font-semibold">
            <nav className="flex items-center justify-between gap-2 w-11/12 mx-auto px-2 py-4">
                ...
                <a href="https://github.com/Pratush26" target="_blank" className="-bg-linear-45 from-purple-500 to-indigo-500 hidden sm:flex items-center justify-between gap-2 text-white px-4 py-2 rounded-sm hover:shadow-md/50 shadow-gray-500 cursor-pointer transition-all duration-300 transition-discrete"><FaGithub className="h-5 w-5" /> Contribute</a>
                <button onClick={() => setIsOpened(!isOpened)} className="sm:hidden">
                    {
                        isOpened ?
                            <RxCross1 />
                            :
            ...
            </nav>
            {
                isOpened
                &&
                <div className="flex flex-col items-center justify-center gap-3 p-2 sm:hidden">
